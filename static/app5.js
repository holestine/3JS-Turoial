...
var example = (function () {
  ...
  function initScene() {
    ...
    var crateTexture      = loader.load('static/textures/crate.gif');
    var earthTexture      = loader.load('static/textures/planets/earth_atmos_4096.jpg');
    var earthNormals      = loader.load('static/textures/planets/earth_normal_2048.jpg');
    var cloudTexture      = loader.load('static/textures/planets/earth_clouds_2048.png');
    var specularTexture   = loader.load('static/textures/planets/earth_specular_2048.jpg');
